...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[ThisServer_DatabaseInformation]
AS
SELECT [server_name]
		,[name]
		...
		,t.DayList AS BackupSchedule_desc
		,[BackupRootPath]
		,[BackupNFiles]
		,[BackupBatchNo]
		,[KeepNBackups]
	...
	FROM [dbo].[DatabaseInformation] AS d
		OUTER APPLY [dbo].[getDayNamesList](BackupSchedule) AS t
	WHERE d.server_name = @@SERVERNAME
